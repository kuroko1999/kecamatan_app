...
@section('page-title', 'Pengaturan Warna Website')
    ...
    <form method="POST" action="{{ route('admin.warna.update') }}" class="p-6 space-y-6">
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="bg_color" value="{{ $bgColor ?? '#0f172a' }}" class="w-16 h-16 rounded-lg border cursor-pointer">
                        <input type="text" name="bg_color" value="{{ $bgColor ?? '#0f172a' }}" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                    </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="text_color" value="{{ $textColor ?? '#ffffff' }}" class="w-16 h-16 rounded-lg border cursor-pointer">
                        <input type="text" name="text_color" value="{{ $textColor ?? '#ffffff' }}" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                    </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex items-center space-x-3">
                    <input type="color" name="card_bg_color" value="{{ $cardBgColor ?? '#1e293b' }}" class="w-16 h-16 rounded-lg border cursor-pointer">
                    <input type="text" name="card_bg_color" value="{{ $cardBgColor ?? '#1e293b' }}" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                </div>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="primary_color" value="{{ $primaryColor ?? '#1a3a6b' }}" class="w-16 h-16 rounded-lg border cursor-pointer">
                        <input type="text" name="primary_color" value="{{ $primaryColor ?? '#1a3a6b' }}" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                    </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="secondary_color" value="{{ $secondaryColor ?? '#d4a017' }}" class="w-16 h-16 rounded-lg border cursor-pointer">
                        <input type="text" name="secondary_color" value="{{ $secondaryColor ?? '#d4a017' }}" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                    </div>
        ...
        <div class="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg">
            ...
            <div class="p-4 rounded-lg" id="previewBg" style="background-color: {{ $bgColor ?? '#0f172a' }};">
                <p id="previewText" style="color: {{ $textColor ?? '#ffffff' }};">Contoh teks dengan warna yang dipilih</p>
                <div class="mt-3 p-3 rounded-lg" id="previewCard" style="background-color: {{ $cardBgColor ?? '#1e293b' }};">
                    <p style="color: {{ $textColor ?? '#ffffff' }};">Contoh card/container</p>
                </div>
                <div class="mt-3 flex gap-2">
                    <button class="px-4 py-2 rounded-lg text-white" id="previewPrimaryBtn" style="background-color: {{ $primaryColor ?? '#1a3a6b' }};">Tombol Primary</button>
                    <button class="px-4 py-2 rounded-lg text-white" id="previewSecondaryBtn" style="background-color: {{ $secondaryColor ?? '#d4a017' }};">Tombol Secondary</button>
                </div>
            </div>
        </div>
        
        <div class="flex justify-end">
            <button type="submit" class="px-6 py-3 rounded-lg text-white transition" style="background: linear-gradient(135deg, {{ $primaryColor ?? '#1a3a6b' }}, #06b6d4);">
