...
<head>
    ...
    <meta name="theme-color" content="<?php echo e($primaryColor ?? '#1a3a6b'); ?>">
    <title><?php echo $__env->yieldContent('title', 'Kabupaten Mukomuko'); ?> - Website Resmi</title>
    ...
    <style>
        ...
        :root {
            --primary: <?php echo e($primaryColor ?? '#1a3a6b'); ?>;
            --primary-dark: <?php echo e($primaryColorDark ?? '#0f2a4f'); ?>;
            --secondary: <?php echo e($secondaryColor ?? '#d4a017'); ?>;
            --secondary-dark: <?php echo e($secondaryColorDark ?? '#b8860b'); ?>;
            --primary-rgb: <?php echo e($primaryRgb ?? '26, 58, 107'); ?>;
            --bg-body: <?php echo e($bgColor ?? '#0f172a'); ?>;
            --text-body: <?php echo e($textColor ?? '#ffffff'); ?>;
            --card-bg: <?php echo e($cardBgColor ?? '#1e293b'); ?>;
            --border-color: <?php echo e($borderColor ?? 'rgba(255,255,255,0.08)'); ?>;
        }
...
</html><?php /**PATH C:\Users\media\OneDrive\Gambar\kecamatan_app\resources\views/layouts/app.blade.php ENDPATH**/ ?>